<?php
// About page for Pombo Retailing United
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <title>About - Pombo Retailing United</title>
    <!-- favicon -->
    ...
    <main class="page">
        <header class="hero">
            <div class="hero-container">
                <div class="hero-text">
                    <h1>About Us</h1>
                    <h4>Pombo Retailing United</h4>
                </div>
            </div>
        </header>
        <section class="content-container" style="padding: 2rem;">
            <h2>About Pombo Retailing United</h2>
            <p>Welcome to Pombo Retailing United - your premier destination for quality pigeons and related services.</p>
        </section>
    </main>
    <!-- footer -->
