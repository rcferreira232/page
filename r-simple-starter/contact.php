<?php
// Contact page for Pombo Retailing United
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <title>Contact - Pombo Retailing United</title>
    <!-- favicon -->
...
<body>
    ...
    <main class="page">
        ...
        <section class="content-container" style="padding: 2rem;">
            <h2>Contact Pombo Retailing United</h2>
            <p>Get in touch with us for all your pigeon-related needs.</p>
        </section>
    </main>
    <!-- footer -->
