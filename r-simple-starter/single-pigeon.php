<?php
// Single pigeon page for Pombo Retailing United
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <title>Pigeon Details - Pombo Retailing United</title>
    <!-- favicon -->
...
<body>
    ...
    <main class="page">
        ...
        <section class="content-container" style="padding: 2rem;">
            <h2>Pigeon: Rudolf</h2>
            <img src="./img/pru.jpg" alt="pigeon" style="width: 100%; max-width: 400px; border-radius: 8px;">
            <p><strong>Price:</strong> R$ 15,00</p>
            <p><strong>Name:</strong> Rudolf</p>
            <p><strong>Description:</strong> Beautiful pigeon available for purchase.</p>
