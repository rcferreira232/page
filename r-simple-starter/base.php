<?php
// Base page for Pombo Retailing United
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <title>Base - Pombo Retailing United</title>
    <!-- favicon -->
    ...
    <main class="page">
        <header class="hero">
            <div class="hero-container">
                <div class="hero-text">
                    <h1>Base</h1>
                    <h4>Foundation page</h4>
                </div>
            </div>
        </header>
        <section class="content-container" style="padding: 2rem;">
            <h2>Base Template</h2>
            <p>This is the base template for Pombo Retailing United.</p>
        </section>
    </main>
    <!-- footer -->
